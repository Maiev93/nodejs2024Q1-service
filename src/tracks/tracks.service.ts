...
export class TracksService {
    ...
    getById(id: string) {
        ...
        if (track) {
            return {
                statusCode: HttpStatus.OK, message: JSON.stringify(track)
            }
        } else {
            return { statusCode: HttpStatus.NOT_FOUND, message: 'Track doesn\'t exist' }
        }
    }
    ...
    create(track: CreateTrackDto) {
        ...
        if (isBodyCorrect) {
            ...
            return { statusCode: HttpStatus.CREATED, message: JSON.stringify(trackData) }
        } else {
    ...
    update(id: string, updateData: UpdateTrackDto) {
        ...
        return {
            statusCode: HttpStatus.OK, message: JSON.stringify(currentTrack)
        }
    }
